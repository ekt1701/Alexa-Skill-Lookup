...
def getDate(intent, session):
    ...
    if newskills == "":
        text = "There were no skills released on " + mydate + ". What other date do you want to try?"
    else:
        text = "Here are the skills released on " + mydate + " " + str(newskills) + ". Do you want to hear another date?"
